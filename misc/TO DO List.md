...
* **[Feito] [PRIORITÁRIO]** **Checar frequência do status (print) "SEM PROJETO" do URBANO** O print vindo do Urbano tá mostrando sem projeto com frequência - é normal
...
* **[Feito] [INTERFACE]** **Barra de Progresso:** 
